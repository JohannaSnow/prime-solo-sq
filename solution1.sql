...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance, user_id) VALUES('George', 'New Orleans', '8', '10', '555.55', '9');
...
-- made a new person to test the delete button- INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance, user_id) VALUES('Deb', 'miami', '1', '2', '10.00', '10');

DELETE FROM syntax_practice WHERE transactions_attempted <5 AND city = 'miami' OR city = 'phoenix';
